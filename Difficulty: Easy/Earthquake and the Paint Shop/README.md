<h2><a href="https://www.geeksforgeeks.org/problems/earthquake-and-the-paint-shop4518/1?page=1&category=Map&difficulty=Easy&status=unsolved&sortBy=submissions">Earthquake and the Paint Shop</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek's&nbsp;Paint Shop is one of the famous shop in Geekland,&nbsp;but 2014 Earthquake caused disarrangement of the items in his shop. Each item in his shop is a 40-digit alpha numeric code .<br>
