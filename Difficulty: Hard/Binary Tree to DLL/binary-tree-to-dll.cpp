...
public:
    ...
    void inOrderTraversal(Node* root, Node*& prev, Node*& head) {
        ...
        // If prev is not NULL, set the links for the doubly linked list
        if (prev == NULL) {
            // The first node visited will be the head of the DLL
            head = root;
        } else {
    ...
    Node* bToDLL(Node* root) {
        ...
        // Perform the in-order traversal and build the DLL
